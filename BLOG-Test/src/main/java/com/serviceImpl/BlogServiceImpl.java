...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public ResponseEntity<List<Blog>> getgetAllBlogOfUser(String email) {
		try {
			List<Blog> userBlog = blogDao.getAllBlogOfUser(email);
			return new ResponseEntity<List<Blog>>(userBlog,HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
		}
